...
final Map<String, String> _cn_ui = {
  ...
  I18n.select_all: '全选',
  I18n.clear: '清空',
  I18n.selected_count: '已选 @count 个',
  I18n.time: '时间',
  I18n.new_name: '新名称',
  ...
  I18n.login_address: '登录地址',
  I18n.home_select_control_script: '选择总控脚本',
  I18n.home_overview_control: '总览与总控制',
  I18n.home_master_switch: '总开关',
  I18n.home_running_count: '运行中: @running / @total',
  I18n.home_total_scripts: '全部脚本',
  I18n.home_control_script_count: '总控脚本: @count',
  I18n.home_no_task: '暂无任务',
  I18n.home_unconfigured_task: '未配置任务',
  I18n.home_running_task: '运行任务',
  I18n.home_pending_task: '队列任务',
  I18n.home_waiting_task: '等待任务',
  I18n.login_error: '登录失败',
  I18n.login_error_msg: 'OAS连接失败,请确认OAS正在运行',
  I18n.retry: '重试',
  I18n.task_manage: '任务管理',
  I18n.task_manage_title: '任务管理',
  I18n.task_search_hint: '搜索任务',
  I18n.task_not_found: '未找到匹配任务',
  I18n.task_menu_load_failed: '任务菜单加载失败',
  I18n.user_setting: '用户设置',
  I18n.turn_on_the_linker: '开启连接器',
  I18n.close_the_linker: '关闭连接器',
  I18n.home_connection_retry_hint: '请确认后端服务是否已成功启动，设置中用户配置是否正确',
  I18n.home_connection_retry_action: '刷新',
  I18n.home_empty_script_hint: '暂无脚本，请先添加脚本',
  I18n.home_loading_auto_deploying: '正在自动部署，请稍后',
  I18n.home_loading_auto_login: '正在登录OAS，请稍后',
  I18n.home_loading_config_detail: '正在加载配置详情，请稍后',
  I18n.success: '成功',
};
